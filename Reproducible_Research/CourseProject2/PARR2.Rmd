...
```{r, brplts, cache=TRUE, fig.width=9, fig.height=6}
par( oma = c( 6, 0, 0, 0 ) )
...
```{r, brpltsdam, cache=TRUE, fig.width=12, fig.height=6}
par(mfrow = c( 1, 2 ))
par(oma = c( 5, 0, 4, 0 ))
